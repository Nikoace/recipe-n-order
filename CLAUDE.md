...
This project is indexed by GitNexus as **recipe-n-order** (366 symbols, 809 relationships, 25 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
