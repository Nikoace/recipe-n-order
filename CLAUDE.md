...
This project is indexed by GitNexus as **recipe-n-order** (371 symbols, 823 relationships, 26 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
